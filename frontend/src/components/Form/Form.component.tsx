...
import { useMediaQuery, useTheme, CircularProgress as MuiCircularProgress } from '@mui/material';
import { InputField } from '@components/InputField';
import { NavLink } from 'react-router-dom';

export const Form=(props:formProps)=>{

    const {btnText,fields,heading,onSubmit,isLoading,text,linkText,linkTo}=props;
    ...
    return(
        <form onSubmit={onSubmit}>
            <StyledBox>
                <Icon icon={LiveTvIcon} size={isDesktop ? "lg" : "md"} iconColor={theme.palette.secondary.main} />
                <Typography
